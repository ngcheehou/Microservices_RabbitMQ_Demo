...
namespace InventoryService.API.Application
{
    public class ProductAppService : IProductAppService
    {
        ...
        public ProductAppService(InventoryDbContext db, IEventPublisher eventPublisher)
        {
            _db = db;
        ...
        public async Task<Product> CreateProduct(CreateProductRequest request)
        {
            ...
            await PublishSafeAsync(EventRoutingKeys.ProductCreated,
                new ProductCreatedEvent(newProduct.Id, newProduct.Name, newProduct.Price));
        ...
        public async Task<Product?> UpdateProduct(Guid id, UpdateProductRequest request)
        {
            ...
            await PublishSafeAsync(EventRoutingKeys.ProductUpdated,
                new ProductUpdatedEvent(existingProduct.Id, existingProduct.Name, existingProduct.Price));
